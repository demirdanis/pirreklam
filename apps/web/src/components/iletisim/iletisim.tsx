...
import type { IletisimData } from './iletisim.types';

interface IletisimProps {
  data: IletisimData;
}

export default function Iletisim({ data }: IletisimProps) {
  return (
    <section
      id="iletisim"
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            >
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-text-mute">
                  Telefon
                </p>
            ...
            <a
              ...
              className="group flex items-start gap-4 rounded-2xl border border-surface-secondary-light-b bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
            >
              <div className="shrink-0 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[#25d366]/10 group-hover:bg-[#25d366] transition-colors">
            ...
            <div className="flex items-start gap-4 rounded-2xl border border-surface-secondary-light-b bg-white p-6 shadow-sm">
              ...
              <div className="flex-1">
                <p className="text-xs font-semibold uppercase tracking-wider text-text-mute mb-2">
                  Çalışma Saatleri
                </p>
